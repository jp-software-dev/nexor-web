...
export default function Hero() {
  const whatsappLink = buildWhatsAppLink(
    'Hola, quiero solicitar una demostración técnica de NEXOR Industrial.',
  );

  return (
    <section id="inicio" className="relative min-h-screen overflow-hidden bg-[#f0f0ee]">
      <video
      ...
      <div className="relative z-10 flex flex-col min-h-screen">
          ...
          >
            {navLinks.map((link) => (
              <Link
                key={link.label}
                to={link.href}
                className="text-[12px] sm:text-[14px] font-medium text-gray-700 hover:text-gray-900 transition-colors duration-200 cursor-pointer"
              >
                {link.label}
              </Link>
            ))}
        ...
        <div className="flex-1 flex items-end pb-10 sm:pb-16 lg:pb-20 px-6 sm:px-12 md:px-20 lg:px-28">
          <div className="max-w-md">
            ...
            >
              Integración Industrial y Médica B2B
            ...
            <h1 className="text-[1.5rem] sm:text-[1.75rem] leading-[1.15] font-medium text-gray-900 tracking-tight mb-3">
              Robótica biónica inteligente diseñada para empresas que exigen precisión.
            </h1>

            <p className="text-[13px] text-gray-500 font-normal mb-4">
              Lleva la capacidad de tu operación al siguiente nivel con efectores finales y prótesis de alta
              ingeniería.
            </p>
            ...
            <a
              ...
              className="inline-flex items-center gap-2 text-[13px] font-medium text-blue-500 border border-blue-400 rounded-full px-5 py-2.5 hover:bg-blue-500 hover:text-white hover:border-blue-500 transition-all duration-200 group cursor-pointer"
            >
